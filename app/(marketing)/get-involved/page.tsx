    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-rasta-red/15 via-black to-rasta-green/10 px-6 py-8 sm:px-10 sm:py-10">
            <div className="pointer-events-none absolute inset-y-0 right-0 w-40 bg-radial from-rasta-gold/25 via-transparent to-transparent opacity-40 blur-2xl" />
            <div className="relative max-w-3xl space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-full bg-rasta-green px-7 py-3 text-sm font-semibold text-black shadow-lg shadow-black/40 transition-transform transition-colors duration-200 hover:-translate-y-0.5 hover:bg-rasta-green/90"
                >
                  Start a conversation
                </Link>
                <Link
                  href="/work"
                  className="inline-flex items-center justify-center rounded-full border border-rasta-gold/80 px-7 py-3 text-sm font-medium text-rasta-gold transition-all duration-200 hover:-translate-y-0.5 hover:border-rasta-gold hover:bg-rasta-gold hover:text-black"
                >
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm text-white/70">
                Every partnership looks a bit different – but most fall
                somewhere in these spaces. Think of them as starting points for
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {waysToSupport.map((way, index) => (
              <article
                key={way.title}
                className="group flex flex-col justify-between rounded-3xl border border-white/10 bg-white/[0.03] p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.02)] transition-all duration-200 hover:-translate-y-1 hover:border-rasta-gold/70 hover:shadow-[0_0_35px_rgba(251,192,45,0.35)]"
              >
                <div>
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span
                      className={[
                        ...
                        index === 0 && "bg-rasta-green group-hover:bg-rasta-green/80",
                        index === 1 && "bg-rasta-gold group-hover:bg-rasta-gold/90",
                        index === 2 && "bg-rasta-red group-hover:bg-rasta-red/80",
                      ]
                        .filter(Boolean)
                        .join(" ")}
                    />
                  ...
                  <ul className="mt-3 space-y-1.5 text-[11px] text-white/75">
                    {way.examples.map((example) => (
                      <li key={example} className="flex gap-2">
                        <span className="mt-1 h-1 w-1 rounded-full bg-white/60 group-hover:bg-rasta-gold/80" />
                        <span>{example}</span>
                      </li>
                    ))}
                  </ul>
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1.4fr)] lg:items-start">
              ...
              <ul className="mt-3 space-y-2 text-sm text-white/80">
                {individualWays.map((item) => (
                  <li key={item} className="flex gap-2">
                    <span className="mt-2 h-1.5 w-4 rounded-full bg-rasta-gold/80 transition-colors duration-200" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="rounded-3xl border border-white/15 bg-gradient-to-r from-rasta-red/25 via-rasta-gold/20 to-rasta-green/25 px-6 py-6 text-sm text-white/85 shadow-[0_0_35px_rgba(0,0,0,0.6)] sm:px-8 sm:py-8">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-full bg-black/80 px-6 py-2.5 text-xs font-semibold text-white shadow shadow-black/60 transition-all duration-200 hover:-translate-y-0.5 hover:bg-black"
                >
                  Use the contact page
                </Link>
                <Link
                  href="/stories"
                  className="inline-flex items-center justify-center rounded-full border border-white/70 px-6 py-2.5 text-xs font-medium text-white/80 transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:text-black"
                >
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="flex flex-col items-start justify-between gap-6 rounded-3xl border border-white/15 bg-gradient-to-r from-rasta-red/20 via-rasta-gold/15 to-rasta-green/20 px-6 py-8 shadow-[0_0_40px_rgba(0,0,0,0.7)] sm:flex-row sm:items-center sm:px-10">
            <div className="space-y-3 max-w-xl">
              ...
              <div className="mt-3 rounded-2xl border border-white/20 bg-black/65 p-4 text-xs text-white/80">
            ...
            <div className="flex max-w-sm flex-col gap-3 text-xs text-white/80">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-full bg-rasta-green px-7 py-3 text-xs font-semibold text-black shadow-lg shadow-black/50 transition-transform duration-200 hover:-translate-y-0.5 hover:bg-rasta-green/90"
              >
      ...
      <section>
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="flex flex-col items-start justify-between gap-6 rounded-3xl border border-white/15 bg-gradient-to-r from-rasta-red/22 via-rasta-gold/18 to-rasta-green/22 px-6 py-8 shadow-[0_0_40px_rgba(0,0,0,0.7)] sm:flex-row sm:items-center sm:px-10">
            <div>
              <h2 className="text-lg font-semibold sm:text-xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/get-involved"
                className="inline-flex items-center justify-center rounded-full bg-rasta-green px-7 py-3 text-sm font-semibold text-black shadow-lg shadow-black/50 transition-transform duration-200 hover:-translate-y-0.5 hover:bg-rasta-green/90"
              >
                Get involved
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-full border border-rasta-gold px-7 py-3 text-sm font-medium text-rasta-gold transition-all duration-200 hover:-translate-y-0.5 hover:bg-rasta-gold hover:text-black"
              >
                Talk to us
              </Link>
            </div>
